# Generated by Django 4.0.6 on 2022-07-24 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.CharField(blank=True, max_length=250, null=True, unique=True)),
                ('status', models.CharField(blank=True, choices=[('ongoing', 'ongoing'), ('completed', 'completed'), ('approved', 'approved'), ('disapproved', 'disapproved')], default='disapproved', max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Student',
